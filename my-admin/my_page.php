...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <?php echo '<br>'.$info.'<br>'; ?>
            <h1 class="page-header"><?php ea('page_pages_page_name'); ?> <a href="{@siteURL@}/my-admin/my_page_new" class="btn btn-primary"><?php ea('page_pages_header_create_new'); ?></a></h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
    <div class="row">
            ...
            <div class="table-responsive">
                <form action="" method="post">
                    <table class="table table-striped table-bordered table-hover" id="tables_posts">
                        ...
                        <?php
                        global $my_db;
                        $page = $my_db->query("SELECT * FROM my_page WHERE pagePUBLIC = '1' AND pageCANDELETE = '1'");
                        $i = 0; foreach($page as $pageinfo){ $i++;
                            ?>
                            <tr>
                                <td><?php echo $pageinfo['pageID']; ?></td>
                                <td><a href="{@siteURL@}/my-admin/page_edit/<?php echo $pageinfo['pageID']; ?>"><?php echo $pageinfo['pageTITLE']; ?></a></td>
                                <td><?php echo $pageinfo['pageURL']; ?></td>
                                <td><?php echo $pageinfo['pageID_MENU']; ?></td>
                                <td><input type="checkbox" name="check_list[]" value="<?php echo $pageinfo['pageID']; ?>"></td>
                            </tr>
                        <?php
                        }
                        ?>
        ...
        <div class="col-lg-6">
            ...
            <select name="ifchecked" class="form-control">
                <option selected="selected" value="delete"><?php ea('page_pages_check_delete'); ?></option>
