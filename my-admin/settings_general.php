...
?>
	<div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header"><?php ea('page_settings_page_header'); ?></h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            <div class="row">
            	<div class="col-lg-6">
                    <form role="form" method="post" action="">
                        ...
                        <option  value="<?php echo get_settings_value('site_timezone'); ?>"><?php echo get_settings_value('site_timezone'); ?></option>
                        ...
                        <option <?php if(get_settings_value('site_maintenance') == "true"){ echo 'selected=""'; } ?> value="true"><?php ea('page_settings_site_mainteinance_on'); ?></option>
                        <option <?php if(get_settings_value('site_maintenance') == "false"){ echo 'selected=""'; } ?> value="false"><?php ea('page_settings_site_mainteinance_off'); ?></option>
                        </select>
                        </div>
                        
                         <input type="submit" name="save_settings_general" class="btn btn-success" value="<?php ea('page_settings_site_button_save'); ?>" />
