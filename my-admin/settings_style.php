...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header"><?php ea('page_settings_style_header'); ?></h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
            ...
            <form role="form" method="post" action="">
                <div class="form-group">
                    ...
                    <select name="settings_style_language" id="settings_style_language" class="form-control">
                        ...
                        $i = 0; foreach($lang as $language){ $i++;
                            ?>
                            <option <?php if($language_language == $language['language_language']){ echo 'selected=""'; }?> value="<?php echo $language['language_language']; ?>"><?php echo $language['language_name']; ?></option>
                        <?php
                        }
                        ?>
                    </select>
