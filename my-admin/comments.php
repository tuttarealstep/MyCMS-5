...
?>
	<div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                <?php echo '<br>'.$info.'<br>'; ?>
                    <h1 class="page-header"><?php ea('page_comments_header'); ?></h1> 
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            <div class="row">
                 ...
                 <form action="" method="post">
                                <table class="table table-striped table-bordered table-hover" id="tables_posts">
                                    ...
                                    <tbody>
										...
										?>
											<tr>
                                            	<td><b><?php if($postinfo['enable'] == '1'){ ea('page_comments_table_approved_yes'); } else { ea('page_comments_table_approved_no'); }?></b></td>
												<td><?php echo $name; ?></td>
												<td><?php echo $postinfo['comments']; ?></td>
												<td><?php echo $postinfo['date']; ?></td>
												<td><input type="checkbox" name="check_list[]" value="<?php echo $postinfo['id']; ?>"></td>	
											</tr>
										<?php
											}
										?>
               ...
               <div class="col-lg-3">
               <p>&nbsp;</p>
               <button type="submit" name="execute" class="btn btn-danger"><?php ea('page_comments_check_button');?></button></div>
               </form>
         	</div>
            </div>
            <!-- /.row -->
