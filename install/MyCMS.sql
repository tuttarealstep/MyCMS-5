...
(1, 'MyCMS', 'MyCMS Example Category');
...
(1, 'Index', '{@siteURL@}/index', '1', 'index', '0', '<h1 style="font-size: 50px; text-align: center;">{@my_cms_welcome_h1@}</h1>', '1'),
...
CREATE TABLE IF NOT EXISTS `my_style` (
  ...
  `style_error_file` varchar(255) NOT NULL,
...
INSERT INTO `my_style` (`style_id`, `style_name`, `style_author`, `style_path_name`, `style_error_file`, `style_maintenance_page`, `style_json_file_url`, `style_version`, `style_languages`, `style_enable_remove`) VALUES
